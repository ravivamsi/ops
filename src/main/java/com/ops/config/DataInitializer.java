...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Operation getUserOp = new Operation("Get User", "Retrieve user information", "https://healthcheckgenerator-b0cb9fb728d6.herokuapp.com/api/api/health/gis2", Operation.HttpMethod.GET);
        getUserOp.setApp(userService);
        operationRepository.save(getUserOp);
        
        Operation createUserOp = new Operation("Create User", "Create new user account", "https://healthcheckgenerator-b0cb9fb728d6.herokuapp.com/api/health/gis1", Operation.HttpMethod.POST);
        createUserOp.setApp(userService);
        operationRepository.save(createUserOp);
        
        Operation processPaymentOp = new Operation("Process Payment", "Process payment transaction", "https://healthcheckgenerator-b0cb9fb728d6.herokuapp.com/api/health/rmd3", Operation.HttpMethod.POST);
        ...
        Operation createOrderOp = new Operation("Create Order", "Create new order", "https://healthcheckgenerator-b0cb9fb728d6.herokuapp.com/api/health/rmd1", Operation.HttpMethod.POST);
